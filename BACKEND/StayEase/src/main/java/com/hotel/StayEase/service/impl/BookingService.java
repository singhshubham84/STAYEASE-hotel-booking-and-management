...
public class BookingService implements IBookingService {
    ...
    public Response findBookingByConfirmationCode(String confirmationCode) {
        ...
        try {
            ...
            BookingDAO bookingDAO = Utils.mapBookingEntityToBookingDAOPlusBookedRooms(booking, true);
            response.setStatusCode(200);
            response.setMessage("successful");
            response.setBooking(bookingDAO);
    ...
    public Response getAllBookings() {
        ...
        try {
            ...
            List<BookingDAO> bookingDAOList = Utils.mapBookingListEntityToBookingListDAO(bookingList);
            response.setStatusCode(200);
            response.setMessage("successful");
            response.setBookingList(bookingDAOList);
